...
Here we build upon modelling skills developed in [Part 1](insert%20link) of this coarse. In **Part 1** we learned how to fit models to data in a *frequentist* paradigm.
